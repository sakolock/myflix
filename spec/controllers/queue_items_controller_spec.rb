...
describe QueueItemsController do
  describe 'GET index' do
    it 'setes the @queue_items to the queue items of the logged in user' do
  ...
  describe "POST update_queue" do
    ...
    context "with invalid inputs" do
      ...
      it "redirects to the my queue page" do # remove setup from all block!!!
        post :update_queue, params: { queue_items: [{id: queue_item1.id, position: 4.2}, {id: queue_item2.id, position: 1}] }
        expect(response).to redirect_to my_queue_path
      end
